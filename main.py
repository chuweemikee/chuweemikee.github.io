...
import openai_utils
import sys
# Append the parent directory of the 'chuweemikee.github.io' folder to the Python path
sys.path.append(str(Path(__file__).parent.parent))

# Import the 'blog_utils' module from the 'chuweemikee.github.io' folder
import blog_utils
import openai_utils

### Define your paths here

PATH_TO_BLOG_REPO = Path('C:\\Users\\genes\\OneDrive\\Documents\\Github\\chuweemikee.github.io\\.git')
